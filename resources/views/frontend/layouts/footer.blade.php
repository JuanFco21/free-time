                        ...
                        <div class="col-md-4">
                            <div class="widget__footer">
                                <figure class="image-logo">
                                    <img src="{{ asset('frontend/assets/img/logo-header.png') }}" alt="Logo Free Time" class="logo-footer">
                                </figure>
                                ...
                                <div class="social__media mt-4">
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#" class="btn btn-social rounded text-white instagram">
                                                <i class="fa fa-instagram"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#" class="btn btn-social rounded text-white youtube">
